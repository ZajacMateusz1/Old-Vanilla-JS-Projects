...
class Game {
    constructor({lettersWrapper, categoryWrapper, wordWrapper, outputImg, modal, modalText}) {
    ...
    startLetters() {
        for (let i=10; i<36; i++) {
            ...
            button.addEventListener('click',(e)=>{this.guess(button.textContent,e)});
    ...
    loseGame() {
        this.modal.classList.add('active');
        this.modalText.textContent = 'Niestety, ale tym raze przegrałeś!!! 😭😭😭😭😭😭';
    };
    changeImg() {
